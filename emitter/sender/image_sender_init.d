...
case "$1" in
  start)
    ...
    start-stop-daemon --start --quiet --background --no-close --make-pidfile --pidfile $PIDFILE --exec /opt/node/bin/node /home/pi/whe/emitter/sender/imageSender.js > /var/log/${NAME}_start.log 2>&1
    echo "."
    ;;
  stop)
