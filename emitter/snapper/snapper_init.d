...
case "$1" in
  start)
    ...
    start-stop-daemon  --start --quiet --background --no-close --make-pidfile --pidfile $PIDFILE -d /home/pi/whe/emitter --exec ./snapper/camcv_vid3 > /var/log/${NAME}_start.log 2>&1
    echo "."
    ;;
  stop)
